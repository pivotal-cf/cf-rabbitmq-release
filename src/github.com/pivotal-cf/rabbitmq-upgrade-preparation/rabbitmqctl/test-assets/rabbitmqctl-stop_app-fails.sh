...
[{pid,5509},
 {running_applications,
     [{rabbitmq_management,"RabbitMQ Management Console","3.4.3.1"},
      {rabbitmq_web_dispatch,"RabbitMQ Web Dispatcher","3.4.3.1"},
      {webmachine,"webmachine","1.10.3-rmq3.4.3.1-gite9359c7"},
      {mochiweb,"MochiMedia Web Server","2.7.0-rmq3.4.3.1-git680dba8"},
      {rabbitmq_mqtt,"RabbitMQ MQTT Adapter","3.4.3.1"},
      {rabbitmq_stomp,"Embedded Rabbit Stomp Adapter","3.4.3.1"},
      {rabbitmq_management_agent,"RabbitMQ Management Agent","3.4.3.1"},
      {rabbit,"RabbitMQ","3.4.3.1"},
      {os_mon,"CPO  CXC 138 46","2.2.15"},
      {mnesia,"MNESIA  CXC 138 12","4.12.1"},
      {amqp_client,"RabbitMQ AMQP Client","3.4.3.1"},
      {rabbitmq_clusterer,"Declarative Clustering","3.4.3.1"},
