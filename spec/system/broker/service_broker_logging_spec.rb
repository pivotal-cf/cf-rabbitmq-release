...
RSpec.describe 'Logging a Cloud Foundry service broker' do
  ...
  RMQ_SERVER_Z1_0_JOB = "rmq_z1"
  RMQ_SERVER_Z1_0_JOB_INDEX = 0
  RMQ_SERVER_Z1_1_JOB = "rmq_z1"
  RMQ_SERVER_Z1_1_JOB_INDEX = 1
  ...
  let(:rmq_server_z1_0_host)  { bosh_director.ips_for_job(RMQ_SERVER_Z1_0_JOB, environment.bosh_manifest.deployment_name)[RMQ_SERVER_Z1_0_JOB_INDEX] }
  let(:rmq_server_z1_1_host)  { bosh_director.ips_for_job(RMQ_SERVER_Z1_1_JOB, environment.bosh_manifest.deployment_name)[RMQ_SERVER_Z1_1_JOB_INDEX] }
