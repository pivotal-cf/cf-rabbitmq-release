...
RSpec.describe 'Configuration', template: true do
  let(:rendered_template) {
    compiled_template('rabbitmq-server', 'setup.sh', manifest_properties, network_properties)
  }
  ...
  describe "nodes" do
    ...
    context 'when static_ips are provided' do
      let(:manifest_properties) { { 'rabbitmq-server' => { 'static_ips' => ['1.1.1.1', '2.2.2.2']} } }
